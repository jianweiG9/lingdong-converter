 ...
 * 
 * <p>This interface represents the intermediate stage of conversion job configuration
 * where the source has been specified and now the target needs to be configured.
 * 
